            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(  
                      ...
                      onPressed: () async {
                        await request.post('https://galihsopod.pythonanywhere.com/delete_user_flutter/${Uri.encodeComponent(user.fields.username)}/', {"status": "success"});
                ...
                if (user.fields.isStaff==false)
                    ElevatedButton(  
                      ...
                      onPressed: () async {
                        await request.post('https://galihsopod.pythonanywhere.com/make_admin_flutter/${Uri.encodeComponent(user.fields.username)}/', {"status": "success"});
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => const ManageUsersPage()),
                        );
                ...
                if (user.fields.isStaff==true)
                    ElevatedButton(  
                      ...
                      onPressed: () async {
                        await request.post('https://galihsopod.pythonanywhere.com/revoke_admin_flutter/${Uri.encodeComponent(user.fields.username)}/', {"status": "success"});
                        Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(builder: (context) => const ManageUsersPage()),
                        );
